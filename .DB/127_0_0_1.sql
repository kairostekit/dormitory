...
CREATE TABLE `make_contract` (
  ...
  `MCO_RM_NUMBER` varchar(100) DEFAULT '',
...
CREATE TABLE `room` (
  `RM_ID` int(11) NOT NULL,
  `RM_NUMBER` varchar(100) NOT NULL DEFAULT '' COMMENT 'เลขห้อง',
...
(5, 'แมเนอร์(Manor)gh', '0', '2023-09-26 18:02:50', '5000.00', '5000.00', '5000.00', '500.00', '500.00', '50', '5000.00', '550.00', '5050', '5050');
