	...
	<?php for ($i = 0; $i < 2; $i++): ?>
		...
		<div class="page">
			...
			<p style="text-indent: 4rem;">
				...
				ผู้ให้เช่าตกลงให้ผู้เช่าใช้สอยทรัพย์สินทุกชนิดที่อยู่ในห้องเช่าและตามรายการทรัพย์สินที่แนบท้ายสัญญานี้
				โดยผู้เช่าจะดูแลรักษาเสมือนหนึ่งว่าเป็นทรัพย์สินของตน
				หากชำรุดบกพร่องใดๆผู้เช่าจะต้องซ่อมแซมให้คงเดิมอยู่เสมอ
			</p>

			<p style="text-indent: 4rem;">
				<span class="text-bold">ข้อ ๕. </span>
				ผู้เช่าตกลงที่จะดูแลรักษาห้องที่เช่าให้คงสภาพดีดังเดิมทุกประการ และยินยอมให้ผู้ให้เช่า
				หรือผู้ที่ได้รับมอบหมายเข้ามาในห้องที่เช่าได้ตลอดเวลา เพื่อตรวจดูสภาพห้องที่เช่าได้ทุกเวลา
				โดยผู้เช่าให้สัญญาว่าจะไม่นำสิ่งผิดกฎหมายเข้ามาในห้องที่เช่า หากผู้ให้เช่าพบหรือบุคคลอื่นพบสิ่งผิดกฎหมาย
				ผู้เช่ายอมให้ผู้ให้เช่าบอกเลิกสัญญาเช่าได้ทันที
			</p>
			<p style="text-indent: 4rem;">
				<span class="text-bold"> ข้อ ๖. </span>
				การเช่าตามข้อ ๑ ให้รวมถึงอุปกรณ์ หรือทรัพย์สินต่างๆ ที่อยู่ในห้องเช่าและ
				รายการทรัพย์สินตามรายการแนบท้ายหนังสือสัญญาเช่านี้
			</p>
			<p style="text-indent: 4rem;">
				<span class="text-bold"> ข้อ ๗. </span>
				ผู้เช่าตกลงที่จะเช่าเพื่อเป็นที่พักอาศัยเท่านั้น และให้สัญญาว่าจะไม่นำห้องที่เช่าออกให้ผู้อื่นเช่าช่วง
				เว้นแต่จะได้รับความยินยอมเป็นหนังสือจากผู้ให้เช่า
			</p>

			<p style="text-indent: 4rem;">
				<span class="text-bold">ข้อ ๘. </span>
				หากผู้เช่าผิดสัญญาข้อหนึ่งข้อใด ยอมให้ผู้ให้เช่าบอกเลิกสัญญาเช่าได้ทันที และยอมชดใช้ค่าเสียหาย
				ค่าขาดประโยชน์ตามความเหมาะสมและตามสมควร เท่าที่ผู้ให้เช่าจะเสียหาย
			</p>
			<p style="text-indent: 4rem;">
				<span class="text-bold">ข้อ ๙. </span>
				หากสัญญาเช่าสิ้นสุดลง โดยไม่มีการต่อสัญญาเช่า หรือผู้ให้เช่าบอกเลิกสัญญาเช่าตามข้อ ๘ ดังกล่าว
				ผู้เช่ายอมขนย้ายทรัพย์สินและบริวารออกไปจากห้องที่เช่าทันทีโดยค่าใช้จ่ายของผู้เช่าเอง
			</p>
			<p style="text-indent: 4rem;">
				<span class="text-bold">ข้อ ๑๐. </span>
				ผู้เช่าสัญญาว่าจะปฏิบัติตามระเบียบข้อบังคับของอาคารโดยถือเป็นส่วนหนึ่งแห่งสัญญาเช่านี้ด้วย
				หากผู้เช่าไม่ปฏิบัติตาม หรือละเมิดข้อบังคับดังกล่าว ผู้เช่ายินดีให้ถือว่าสัญญาเช่านี้เป็นอันยกเลิกต่อกัน
				และยินยอมมอบการครอบครองห้องเช่าคืนแก่ผู้ให้เช่าทันที
			</p>
			<p style="text-indent: 4rem;">
