...
class CRM_PAY_MODELS extends CI_Model
{
    var $mssqlrmst;
    private $mssql = null;
    private static $smssql = null;
    // private $PRIMARY_KEY = "CRMP_ID";
    private static $sPRIMARY_KEY = "CRMP_ID";
    // public static $sDB_NAME = "LalinMISService";
    // public static $sSCHEMA = "dbo";
    // public $TABLE_NAME = "CRM_PAY";
    public static $sTABLE_NAME = "CRM_PAY";
